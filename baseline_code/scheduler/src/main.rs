...
async fn main() {
    ...
    let schedule = Arc::new(Mutex::new(get_schedule("GS"))); // Changed for baseline
...
async fn handle_task(
    ...
    let delay = Duration::from_secs_f64(delay_f64 * 0.0); // Changed DF to 0.0 for baseline experiments
