...
def scenario(net, log_dir, code_dir):
    ...
    client_delay = '30ms'
    client_jitter = '0ms'
    client_poisson_lambda = float(args.ntasks / n_clients)
    client_payload_bytes = 100
    client_task_wcet_ms = 10
    client_task_slack_time_mean_ms = 100
    n_workers = 4
    sched_algo = 'PSWF'
    sched_delay_factor = args.uf
    ...
    print(
        ...
        f'Mean Task Laxity at Submission & {client_task_slack_time_mean_ms}ms\\\\\n'
